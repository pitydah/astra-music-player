...
class EpisodesTab(QWidget):
    ...
    def _build_ui(self):
        ...
        self._filter_combo.addItems(["Todos", "Nuevos", "En progreso", "Favoritos"])
    ...
    def _reload(self):
        ...
        if filter_text == "Nuevos":
            episodes = self._pm.get_unplayed_episodes(100)
        elif filter_text == "En progreso":
            episodes = self._pm.get_in_progress_episodes(100)
        else:
            episodes = self._pm.get_recent_episodes(100)
