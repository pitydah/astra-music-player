...
SECTION_CONFIG: dict[str, dict] = {
    ...
    "audio_lab_vinyl_lab": {"title": "Vinyl Lab",
                            ...
                            "icon": "home_audio", "views": [],
                            "search": False, "default": None},
    "audio_lab_lyrics": {"title": "Letras",
                         "subtitle": "Busca, edita y guarda letras de canciones en tus archivos",
                         "icon": "sidebar_mix", "views": [],
                         "search": False, "default": None},
    "audio_lab_artwork": {"title": "Carátulas",
                          "subtitle": "Gestiona, reemplaza e incrusta carátulas en tus archivos de música",
                          "icon": "sidebar_albums", "views": [],
                          "search": False, "default": None},
...
NAV_ROUTES: dict[str, str] = {
    ...
    "audio_lab_lyrics": "_show_audio_lab_lyrics",
    "audio_lab_artwork": "_show_audio_lab_artwork",
...
class NavigationController(QObject):
    ...
    def _build_breadcrumb(self, subtitle: str, section_key: str) -> str:
        ...
        hub_names = {
            ...
            "audio_lab_lyrics": "Audio Lab",
            "audio_lab_artwork": "Audio Lab",
