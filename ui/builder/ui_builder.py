...
class UIBuilder:
    ...
    def build(self):
        ...
        settings_menu.addAction(w._open_file_action)
        settings_menu.addAction(w._add_folder_action)
        settings_menu.addSeparator()
        settings_menu.addAction(w._import_playlist_action)
        settings_menu.addAction(w._export_playlist_action)
        settings_menu.addSeparator()
        transmit_sub = settings_menu.addMenu("Transmitir")
        transmit_sub.addAction(w._add_transmit_device_action)
        transmit_sub.addAction(w._manage_transmit_devices_action)
        settings_menu.addSeparator()
        ...
        settings_menu.addSeparator()
        settings_menu.addAction(w._quit_action)
