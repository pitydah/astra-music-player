...
class SyncManager(QObject):
    ...
    def _load_alias(self) -> str:
        path = os.path.expanduser("~/.local/share/music_player/sync_alias")
    ...
    def _save_alias(self, alias: str):
        os.makedirs(os.path.expanduser("~/.local/share/music_player"),
                   exist_ok=True)
        with open(os.path.expanduser(
            "~/.local/share/music_player/sync_alias"), "w") as f:
            f.write(alias)
